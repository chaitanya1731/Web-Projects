...
export default class Validator {
  ...
  validate(category, act, obj) {
    if(obj.hasOwnProperty('_id')){
      //BAD_FIELD: the internal mongo _id field is forbidden for users create
      throw [new BlogError('BAD_FIELD', `the internal mongo _id field is forbidden for ${category} ${act}`)]
    }
    const out = {};
